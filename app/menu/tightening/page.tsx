...
export default function TighteningSetPage() {
  return (
    <main>
      {/* Hero Section */}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden mb-12">
              ...
              <div className="p-8 text-center">
                <h1 className="text-3xl font-bold mb-4">タイトニングセット</h1>
                <p className="text-lg text-[#81D8D0] font-bold">
                  ¥59,800 <span className="text-base font-normal text-gray-600">(税込) / 1回</span>
                </p>
              </div>
            </div>
              ...
              <div className="mb-12">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="font-bold mb-2">ハイドラ</h3>
                    <p className="text-gray-600">毛穴の汚れを吸引しながら美容成分を浸透させ、クリアな素肌へ導きます。</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="font-bold mb-2">ポテンツァタイトニング</h3>
                    <p className="text-gray-600">RF（ラジオ波）とマイクロニードルの相乗効果で、肌のハリ・弾力を改善します。</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="font-bold mb-2">エレクトロポレーション</h3>
                    <p className="text-gray-600">微弱な電流で美容成分の浸透を促進し、さらなる肌質の改善を促します。</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold mb-1">ハイドラ施術</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold mb-1">ポテンツァタイトニング</h3>
                      <p className="text-gray-600">RF（ラジオ波）とマイクロニードルによる集中的なハリ・弾力改善を行います。</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-[#81D8D0] text-white rounded-full flex items-center justify-center flex-shrink-0">4</div>
                    <div>
