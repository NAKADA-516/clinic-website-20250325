...
export default function ElectroporationPage() {
  const basicPriceItems = [
    { name: "エレクトロポレーション", price: "¥3,000" },
    { name: "エレクトロポレーション＋導入液", price: "¥4,000" },
    { name: "エレクトロポレーション＋導入液＋マッサージ", price: "¥5,000" },
    { name: "エレクトロポレーション＋導入液＋マッサージ＋パック", price: "¥6,000" },
    { name: "エレクトロポレーション＋導入液＋マッサージ＋パック＋保湿", price: "¥7,000" },
  ];

  const premiumPriceItems = [
    { name: "プレミアムエレクトロポレーション", price: "¥5,000" },
    { name: "プレミアムエレクトロポレーション＋導入液", price: "¥6,000" },
    { name: "プレミアムエレクトロポレーション＋導入液＋マッサージ", price: "¥7,000" },
    { name: "プレミアムエレクトロポレーション＋導入液＋マッサージ＋パック", price: "¥8,000" },
    { name: "プレミアムエレクトロポレーション＋導入液＋マッサージ＋パック＋保湿", price: "¥9,000" },
  ];
